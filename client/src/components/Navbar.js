      ...
      {open && (
        <ul className="md:hidden bg-white px-4 pb-4 space-y-2 font-medium text-gray-700">
          ...
          {token ? (
            ...
            <>
              <li>
                <Link to="/login" className="hover:text-blue-600" onClick={() => setOpen(false)}>Login</Link>
              </li>
              <li>
                <Link to="/signup" className="hover:text-blue-600" onClick={() => setOpen(false)}>Sign Up</Link>
              </li>
            </>
          )}
        </ul>
